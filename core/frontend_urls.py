...
from .frontend_actions_clean import register_submit, register_submit_v2, create_offer_view, edit_offer_view, company_profile_view, save_chat_message, company_offers_json, toggle_offer_status_view, delete_offer_view, company_dashboard_json, company_internships_json, company_pending_applicants_json, update_application_status
...
urlpatterns = [
    ...
    path('internship/<str:internship_id>/', frontend_views.view_internship, name='view-internship'),
    path('internship/<str:internship_id>/log-hours/', frontend_views.log_hours, name='log-hours'),
    ...
    path('student/opportunities/<str:opportunity_id>/apply/', frontend_views.apply_to_opportunity, name='apply-to-opportunity'),
    path('student/opportunities/<str:internship_id>/', frontend_views.view_internship, name='student-opportunity-detail'),
    ...
    path('student/internship/<str:internship_id>/', frontend_views.view_internship, name='student-internship-detail'),
    path('student/internship/<str:internship_id>/log-hours/', frontend_views.log_hours, name='student-log-hours'),
    path('student/profile/', frontend_views.student_profile, name='student-profile'),
    path('student/careers/<str:institution_id>/', frontend_views.careers_by_institution_json, name='careers-by-institution'),
    ...
    path('company/offers/<str:offer_id>/edit/', edit_offer_view, name='edit-offer'),
    path('company/offers/<str:offer_id>/', edit_offer_view, name='company-offer-detail'),
    path('company/offers/<str:offer_id>/applicants/', frontend_views.applicants_view, name='company-offer-applicants'),
    path('company/offers/<str:offer_id>/toggle-status/', toggle_offer_status_view, name='toggle-offer-status'),
    path('company/offers/<str:offer_id>/delete/', delete_offer_view, name='delete-offer'),
    ...
    path('company/internships/<str:internship_id>/', frontend_views.company_internships, name='company-internship-detail'),
    path('company/pending-applicants/json/', company_pending_applicants_json, name='company-pending-applicants-json'),
    path('company/applications/<str:application_id>/status/', update_application_status, name='update-application-status'),
    path('company/internships/<str:internship_id>/evaluate/', frontend_views.hours_validation, name='company-internship-evaluate'),
